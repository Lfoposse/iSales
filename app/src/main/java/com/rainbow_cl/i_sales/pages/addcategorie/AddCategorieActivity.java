package com.rainbow_cl.i_sales.pages.addcategorie;
...
//        progressDialog.setTitle("Transfert d'Argent");
        ...
        Categorie queryBody = new Categorie();
        queryBody.setLabel(label);
        queryBody.setDescription(ISalesUtility.ENCODE_DESC+label+ISalesUtility.ENCODE_DESC);
