...
public class Thirdpartie {
    ...
    private String remise_supplier_percent;
    ...
    public String getRemise_supplier_percent() {
        return remise_supplier_percent;
    }

    public void setRemise_supplier_percent(String remise_supplier_percent) {
    ...
    public void setCode_compta(String code_compta) {
